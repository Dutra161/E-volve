...
var myChart7K8ME_B = 0;
var ctx = document.getElementById('7K8ME-B').getContext('2d');
if (window.myChart7K8ME_B != 0){
    window.myChart7K8ME_B.destroy();
}
window.myChart7K8ME_B = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

...
var myChart7JW0E_G = 0;
var ctx = document.getElementById('7JW0E-G').getContext('2d');
if (window.myChart7JW0E_G != 0){
    window.myChart7JW0E_G.destroy();
}
window.myChart7JW0E_G = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

...
var myChart6XDGE_A = 0;
var ctx = document.getElementById('6XDGE-A').getContext('2d');
if (window.myChart6XDGE_A != 0){
    window.myChart6XDGE_A.destroy();
}
window.myChart6XDGE_A = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

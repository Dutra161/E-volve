...
var myChart7KXJB_M = 0;
var ctx = document.getElementById('7KXJB-M').getContext('2d');
if (window.myChart7KXJB_M != 0){
    window.myChart7KXJB_M.destroy();
}
window.myChart7KXJB_M = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

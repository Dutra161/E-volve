...
var myChart7CWSR_F = 0;
var ctx = document.getElementById('7CWSR-F').getContext('2d');
if (window.myChart7CWSR_F != 0){
    window.myChart7CWSR_F.destroy();
}
window.myChart7CWSR_F = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

...
var myChart7KMGF_A = 0;
var ctx = document.getElementById('7KMGF-A').getContext('2d');
if (window.myChart7KMGF_A != 0){
    window.myChart7KMGF_A.destroy();
}
window.myChart7KMGF_A = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

...
var myChart6ZFOE_H = 0;
var ctx = document.getElementById('6ZFOE-H').getContext('2d');
if (window.myChart6ZFOE_H != 0){
    window.myChart6ZFOE_H.destroy();
}
window.myChart6ZFOE_H = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

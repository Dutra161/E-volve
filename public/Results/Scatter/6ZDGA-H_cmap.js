...
var myChart6ZDGA_H = 0;
var ctx = document.getElementById('6ZDGA-H').getContext('2d');
if (window.myChart6ZDGA_H != 0){
    window.myChart6ZDGA_H.destroy();
}
window.myChart6ZDGA_H = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

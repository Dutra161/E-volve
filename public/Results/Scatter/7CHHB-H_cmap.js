...
var myChart7CHHB_H = 0;
var ctx = document.getElementById('7CHHB-H').getContext('2d');
if (window.myChart7CHHB_H != 0){
    window.myChart7CHHB_H.destroy();
}
window.myChart7CHHB_H = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

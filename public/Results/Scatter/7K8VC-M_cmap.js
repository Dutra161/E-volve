...
var myChart7K8VC_M = 0;
var ctx = document.getElementById('7K8VC-M').getContext('2d');
if (window.myChart7K8VC_M != 0){
    window.myChart7K8VC_M.destroy();
}
window.myChart7K8VC_M = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

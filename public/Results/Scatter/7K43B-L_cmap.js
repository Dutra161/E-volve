...
var myChart7K43B_L = 0;
var ctx = document.getElementById('7K43B-L').getContext('2d');
if (window.myChart7K43B_L != 0){
    window.myChart7K43B_L.destroy();
}
window.myChart7K43B_L = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

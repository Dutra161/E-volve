...
var myChart7JVCE_G = 0;
var ctx = document.getElementById('7JVCE-G').getContext('2d');
if (window.myChart7JVCE_G != 0){
    window.myChart7JVCE_G.destroy();
}
window.myChart7JVCE_G = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

...
var myChart7KN7A_H = 0;
var ctx = document.getElementById('7KN7A-H').getContext('2d');
if (window.myChart7KN7A_H != 0){
    window.myChart7KN7A_H.destroy();
}
window.myChart7KN7A_H = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

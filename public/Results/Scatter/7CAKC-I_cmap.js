...
var myChart7CAKC_I = 0;
var ctx = document.getElementById('7CAKC-I').getContext('2d');
if (window.myChart7CAKC_I != 0){
    window.myChart7CAKC_I.destroy();
}
window.myChart7CAKC_I = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

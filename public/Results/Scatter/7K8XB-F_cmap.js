...
var myChart7K8XB_F = 0;
var ctx = document.getElementById('7K8XB-F').getContext('2d');
if (window.myChart7K8XB_F != 0){
    window.myChart7K8XB_F.destroy();
}
window.myChart7K8XB_F = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

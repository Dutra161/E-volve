...
var myChart7CWUB_H = 0;
var ctx = document.getElementById('7CWUB-H').getContext('2d');
if (window.myChart7CWUB_H != 0){
    window.myChart7CWUB_H.destroy();
}
window.myChart7CWUB_H = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

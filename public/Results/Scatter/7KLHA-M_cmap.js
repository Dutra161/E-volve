...
var myChart7KLHA_M = 0;
var ctx = document.getElementById('7KLHA-M').getContext('2d');
if (window.myChart7KLHA_M != 0){
    window.myChart7KLHA_M.destroy();
}
window.myChart7KLHA_M = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

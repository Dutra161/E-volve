...
var myChart7JV6B_C = 0;
var ctx = document.getElementById('7JV6B-C').getContext('2d');
if (window.myChart7JV6B_C != 0){
    window.myChart7JV6B_C.destroy();
}
window.myChart7JV6B_C = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

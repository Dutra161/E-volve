...
var myChart7KMGC_D = 0;
var ctx = document.getElementById('7KMGC-D').getContext('2d');
if (window.myChart7KMGC_D != 0){
    window.myChart7KMGC_D.destroy();
}
window.myChart7KMGC_D = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

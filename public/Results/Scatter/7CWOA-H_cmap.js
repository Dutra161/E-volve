...
var myChart7CWOA_H = 0;
var ctx = document.getElementById('7CWOA-H').getContext('2d');
if (window.myChart7CWOA_H != 0){
    window.myChart7CWOA_H.destroy();
}
window.myChart7CWOA_H = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

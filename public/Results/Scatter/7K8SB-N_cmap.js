...
var myChart7K8SB_N = 0;
var ctx = document.getElementById('7K8SB-N').getContext('2d');
if (window.myChart7K8SB_N != 0){
    window.myChart7K8SB_N.destroy();
}
window.myChart7K8SB_N = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

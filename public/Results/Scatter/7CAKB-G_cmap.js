...
var myChart7CAKB_G = 0;
var ctx = document.getElementById('7CAKB-G').getContext('2d');
if (window.myChart7CAKB_G != 0){
    window.myChart7CAKB_G.destroy();
}
window.myChart7CAKB_G = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

...
var myChart7KN5A_D = 0;
var ctx = document.getElementById('7KN5A-D').getContext('2d');
if (window.myChart7KN5A_D != 0){
    window.myChart7KN5A_D.destroy();
}
window.myChart7KN5A_D = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

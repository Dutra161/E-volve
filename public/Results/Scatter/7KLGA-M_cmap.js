...
var myChart7KLGA_M = 0;
var ctx = document.getElementById('7KLGA-M').getContext('2d');
if (window.myChart7KLGA_M != 0){
    window.myChart7KLGA_M.destroy();
}
window.myChart7KLGA_M = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

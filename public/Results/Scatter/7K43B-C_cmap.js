...
var myChart7K43B_C = 0;
var ctx = document.getElementById('7K43B-C').getContext('2d');
if (window.myChart7K43B_C != 0){
    window.myChart7K43B_C.destroy();
}
window.myChart7K43B_C = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

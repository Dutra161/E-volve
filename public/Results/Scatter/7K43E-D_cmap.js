...
var myChart7K43E_D = 0;
var ctx = document.getElementById('7K43E-D').getContext('2d');
if (window.myChart7K43E_D != 0){
    window.myChart7K43E_D.destroy();
}
window.myChart7K43E_D = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

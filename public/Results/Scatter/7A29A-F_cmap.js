...
var myChart7A29A_F = 0;
var ctx = document.getElementById('7A29A-F').getContext('2d');
if (window.myChart7A29A_F != 0){
    window.myChart7A29A_F.destroy();
}
window.myChart7A29A_F = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

...
var myChart7JV4A_L = 0;
var ctx = document.getElementById('7JV4A-L').getContext('2d');
if (window.myChart7JV4A_L != 0){
    window.myChart7JV4A_L.destroy();
}
window.myChart7JV4A_L = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

...
var myChart7K4NE_G = 0;
var ctx = document.getElementById('7K4NE-G').getContext('2d');
if (window.myChart7K4NE_G != 0){
    window.myChart7K4NE_G.destroy();
}
window.myChart7K4NE_G = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

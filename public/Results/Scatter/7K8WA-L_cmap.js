...
var myChart7K8WA_L = 0;
var ctx = document.getElementById('7K8WA-L').getContext('2d');
if (window.myChart7K8WA_L != 0){
    window.myChart7K8WA_L.destroy();
}
window.myChart7K8WA_L = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

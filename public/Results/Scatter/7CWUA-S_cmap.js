...
var myChart7CWUA_S = 0;
var ctx = document.getElementById('7CWUA-S').getContext('2d');
if (window.myChart7CWUA_S != 0){
    window.myChart7CWUA_S.destroy();
}
window.myChart7CWUA_S = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

...
var myChart7CWSQ_D = 0;
var ctx = document.getElementById('7CWSQ-D').getContext('2d');
if (window.myChart7CWSQ_D != 0){
    window.myChart7CWSQ_D.destroy();
}
window.myChart7CWSQ_D = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

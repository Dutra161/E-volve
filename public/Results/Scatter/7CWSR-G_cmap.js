...
var myChart7CWSR_G = 0;
var ctx = document.getElementById('7CWSR-G').getContext('2d');
if (window.myChart7CWSR_G != 0){
    window.myChart7CWSR_G.destroy();
}
window.myChart7CWSR_G = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

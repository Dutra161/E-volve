...
var myChart7KXKA_N = 0;
var ctx = document.getElementById('7KXKA-N').getContext('2d');
if (window.myChart7KXKA_N != 0){
    window.myChart7KXKA_N.destroy();
}
window.myChart7KXKA_N = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

...
var myChart7K90A_M = 0;
var ctx = document.getElementById('7K90A-M').getContext('2d');
if (window.myChart7K90A_M != 0){
    window.myChart7K90A_M.destroy();
}
window.myChart7K90A_M = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

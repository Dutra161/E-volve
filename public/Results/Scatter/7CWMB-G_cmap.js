...
var myChart7CWMB_G = 0;
var ctx = document.getElementById('7CWMB-G').getContext('2d');
if (window.myChart7CWMB_G != 0){
    window.myChart7CWMB_G.destroy();
}
window.myChart7CWMB_G = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

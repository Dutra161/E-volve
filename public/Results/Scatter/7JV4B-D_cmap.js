...
var myChart7JV4B_D = 0;
var ctx = document.getElementById('7JV4B-D').getContext('2d');
if (window.myChart7JV4B_D != 0){
    window.myChart7JV4B_D.destroy();
}
window.myChart7JV4B_D = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

...
var myChart7KXKB_J = 0;
var ctx = document.getElementById('7KXKB-J').getContext('2d');
if (window.myChart7KXKB_J != 0){
    window.myChart7KXKB_J.destroy();
}
window.myChart7KXKB_J = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

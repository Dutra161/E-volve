...
var myChart7CWUC_I = 0;
var ctx = document.getElementById('7CWUC-I').getContext('2d');
if (window.myChart7CWUC_I != 0){
    window.myChart7CWUC_I.destroy();
}
window.myChart7CWUC_I = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

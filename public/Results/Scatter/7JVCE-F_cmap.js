...
var myChart7JVCE_F = 0;
var ctx = document.getElementById('7JVCE-F').getContext('2d');
if (window.myChart7JVCE_F != 0){
    window.myChart7JVCE_F.destroy();
}
window.myChart7JVCE_F = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

...
var myChart6XC7A_H = 0;
var ctx = document.getElementById('6XC7A-H').getContext('2d');
if (window.myChart6XC7A_H != 0){
    window.myChart6XC7A_H.destroy();
}
window.myChart6XC7A_H = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

...
var myChart7CWMA_L = 0;
var ctx = document.getElementById('7CWMA-L').getContext('2d');
if (window.myChart7CWMA_L != 0){
    window.myChart7CWMA_L.destroy();
}
window.myChart7CWMA_L = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

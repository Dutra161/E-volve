...
var myChart7KLHA_L = 0;
var ctx = document.getElementById('7KLHA-L').getContext('2d');
if (window.myChart7KLHA_L != 0){
    window.myChart7KLHA_L.destroy();
}
window.myChart7KLHA_L = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

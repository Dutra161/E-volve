...
var myChart7KFWB_D = 0;
var ctx = document.getElementById('7KFWB-D').getContext('2d');
if (window.myChart7KFWB_D != 0){
    window.myChart7KFWB_D.destroy();
}
window.myChart7KFWB_D = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

...
var myChart7KMGF_B = 0;
var ctx = document.getElementById('7KMGF-B').getContext('2d');
if (window.myChart7KMGF_B != 0){
    window.myChart7KMGF_B.destroy();
}
window.myChart7KMGF_B = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

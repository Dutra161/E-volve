...
var myChart7JW0E_F = 0;
var ctx = document.getElementById('7JW0E-F').getContext('2d');
if (window.myChart7JW0E_F != 0){
    window.myChart7JW0E_F.destroy();
}
window.myChart7JW0E_F = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

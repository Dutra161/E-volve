...
var myChart6ZDGA_B = 0;
var ctx = document.getElementById('6ZDGA-B').getContext('2d');
if (window.myChart6ZDGA_B != 0){
    window.myChart6ZDGA_B.destroy();
}
window.myChart6ZDGA_B = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

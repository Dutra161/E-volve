...
var myChart7KMIC_B = 0;
var ctx = document.getElementById('7KMIC-B').getContext('2d');
if (window.myChart7KMIC_B != 0){
    window.myChart7KMIC_B.destroy();
}
window.myChart7KMIC_B = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

...
var myChart7CWNA_O = 0;
var ctx = document.getElementById('7CWNA-O').getContext('2d');
if (window.myChart7CWNA_O != 0){
    window.myChart7CWNA_O.destroy();
}
window.myChart7CWNA_O = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

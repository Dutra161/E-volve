...
var myChart7CWNC_J = 0;
var ctx = document.getElementById('7CWNC-J').getContext('2d');
if (window.myChart7CWNC_J != 0){
    window.myChart7CWNC_J.destroy();
}
window.myChart7CWNC_J = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

...
var myChart7CWMB_J = 0;
var ctx = document.getElementById('7CWMB-J').getContext('2d');
if (window.myChart7CWMB_J != 0){
    window.myChart7CWMB_J.destroy();
}
window.myChart7CWMB_J = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

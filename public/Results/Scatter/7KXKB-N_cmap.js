...
var myChart7KXKB_N = 0;
var ctx = document.getElementById('7KXKB-N').getContext('2d');
if (window.myChart7KXKB_N != 0){
    window.myChart7KXKB_N.destroy();
}
window.myChart7KXKB_N = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

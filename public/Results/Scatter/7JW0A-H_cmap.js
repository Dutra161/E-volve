...
var myChart7JW0A_H = 0;
var ctx = document.getElementById('7JW0A-H').getContext('2d');
if (window.myChart7JW0A_H != 0){
    window.myChart7JW0A_H.destroy();
}
window.myChart7JW0A_H = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

...
var myChart7DPMC_B = 0;
var ctx = document.getElementById('7DPMC-B').getContext('2d');
if (window.myChart7DPMC_B != 0){
    window.myChart7DPMC_B.destroy();
}
window.myChart7DPMC_B = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

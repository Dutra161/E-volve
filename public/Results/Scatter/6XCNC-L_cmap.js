...
var myChart6XCNC_L = 0;
var ctx = document.getElementById('6XCNC-L').getContext('2d');
if (window.myChart6XCNC_L != 0){
    window.myChart6XCNC_L.destroy();
}
window.myChart6XCNC_L = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

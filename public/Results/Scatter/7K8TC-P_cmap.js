...
var myChart7K8TC_P = 0;
var ctx = document.getElementById('7K8TC-P').getContext('2d');
if (window.myChart7K8TC_P != 0){
    window.myChart7K8TC_P.destroy();
}
window.myChart7K8TC_P = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

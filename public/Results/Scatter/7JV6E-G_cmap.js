...
var myChart7JV6E_G = 0;
var ctx = document.getElementById('7JV6E-G').getContext('2d');
if (window.myChart7JV6E_G != 0){
    window.myChart7JV6E_G.destroy();
}
window.myChart7JV6E_G = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

...
var myChart7A5SB_M = 0;
var ctx = document.getElementById('7A5SB-M').getContext('2d');
if (window.myChart7A5SB_M != 0){
    window.myChart7A5SB_M.destroy();
}
window.myChart7A5SB_M = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

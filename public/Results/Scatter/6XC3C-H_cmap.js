...
var myChart6XC3C_H = 0;
var ctx = document.getElementById('6XC3C-H').getContext('2d');
if (window.myChart6XC3C_H != 0){
    window.myChart6XC3C_H.destroy();
}
window.myChart6XC3C_H = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

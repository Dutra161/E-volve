...
var myChart7KMGC_E = 0;
var ctx = document.getElementById('7KMGC-E').getContext('2d');
if (window.myChart7KMGC_E != 0){
    window.myChart7KMGC_E.destroy();
}
window.myChart7KMGC_E = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

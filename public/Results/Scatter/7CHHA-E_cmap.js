...
var myChart7CHHA_E = 0;
var ctx = document.getElementById('7CHHA-E').getContext('2d');
if (window.myChart7CHHA_E != 0){
    window.myChart7CHHA_E.destroy();
}
window.myChart7CHHA_E = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

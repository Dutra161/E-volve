...
var myChart7KFWA_H = 0;
var ctx = document.getElementById('7KFWA-H').getContext('2d');
if (window.myChart7KFWA_H != 0){
    window.myChart7KFWA_H.destroy();
}
window.myChart7KFWA_H = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

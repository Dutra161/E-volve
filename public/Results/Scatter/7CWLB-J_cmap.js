...
var myChart7CWLB_J = 0;
var ctx = document.getElementById('7CWLB-J').getContext('2d');
if (window.myChart7CWLB_J != 0){
    window.myChart7CWLB_J.destroy();
}
window.myChart7CWLB_J = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

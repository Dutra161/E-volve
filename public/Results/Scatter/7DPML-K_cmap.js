...
var myChart7DPML_K = 0;
var ctx = document.getElementById('7DPML-K').getContext('2d');
if (window.myChart7DPML_K != 0){
    window.myChart7DPML_K.destroy();
}
window.myChart7DPML_K = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

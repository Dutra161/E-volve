...
var myChart7JVCA_H = 0;
var ctx = document.getElementById('7JVCA-H').getContext('2d');
if (window.myChart7JVCA_H != 0){
    window.myChart7JVCA_H.destroy();
}
window.myChart7JVCA_H = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

...
var myChart7K8XB_E = 0;
var ctx = document.getElementById('7K8XB-E').getContext('2d');
if (window.myChart7K8XB_E != 0){
    window.myChart7K8XB_E.destroy();
}
window.myChart7K8XB_E = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

...
var myChart6ZDGA_C = 0;
var ctx = document.getElementById('6ZDGA-C').getContext('2d');
if (window.myChart6ZDGA_C != 0){
    window.myChart6ZDGA_C.destroy();
}
window.myChart6ZDGA_C = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

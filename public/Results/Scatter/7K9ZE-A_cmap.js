...
var myChart7K9ZE_A = 0;
var ctx = document.getElementById('7K9ZE-A').getContext('2d');
if (window.myChart7K9ZE_A != 0){
    window.myChart7K9ZE_A.destroy();
}
window.myChart7K9ZE_A = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

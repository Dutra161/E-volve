...
var myChart7CWMA_H = 0;
var ctx = document.getElementById('7CWMA-H').getContext('2d');
if (window.myChart7CWMA_H != 0){
    window.myChart7CWMA_H.destroy();
}
window.myChart7CWMA_H = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

...
var myChart7KXKB_M = 0;
var ctx = document.getElementById('7KXKB-M').getContext('2d');
if (window.myChart7KXKB_M != 0){
    window.myChart7KXKB_M.destroy();
}
window.myChart7KXKB_M = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

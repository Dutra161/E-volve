...
var myChart7A5RA_L = 0;
var ctx = document.getElementById('7A5RA-L').getContext('2d');
if (window.myChart7A5RA_L != 0){
    window.myChart7A5RA_L.destroy();
}
window.myChart7A5RA_L = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

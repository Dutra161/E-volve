...
var myChart7JW0A_L = 0;
var ctx = document.getElementById('7JW0A-L').getContext('2d');
if (window.myChart7JW0A_L != 0){
    window.myChart7JW0A_L.destroy();
}
window.myChart7JW0A_L = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

...
var myChart7KXKA_H = 0;
var ctx = document.getElementById('7KXKA-H').getContext('2d');
if (window.myChart7KXKA_H != 0){
    window.myChart7KXKA_H.destroy();
}
window.myChart7KXKA_H = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

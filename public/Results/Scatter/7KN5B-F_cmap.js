...
var myChart7KN5B_F = 0;
var ctx = document.getElementById('7KN5B-F').getContext('2d');
if (window.myChart7KN5B_F != 0){
    window.myChart7KN5B_F.destroy();
}
window.myChart7KN5B_F = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

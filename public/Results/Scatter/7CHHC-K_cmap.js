...
var myChart7CHHC_K = 0;
var ctx = document.getElementById('7CHHC-K').getContext('2d');
if (window.myChart7CHHC_K != 0){
    window.myChart7CHHC_K.destroy();
}
window.myChart7CHHC_K = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

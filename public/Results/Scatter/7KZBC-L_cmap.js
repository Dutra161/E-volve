...
var myChart7KZBC_L = 0;
var ctx = document.getElementById('7KZBC-L').getContext('2d');
if (window.myChart7KZBC_L != 0){
    window.myChart7KZBC_L.destroy();
}
window.myChart7KZBC_L = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

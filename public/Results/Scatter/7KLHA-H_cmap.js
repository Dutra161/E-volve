...
var myChart7KLHA_H = 0;
var ctx = document.getElementById('7KLHA-H').getContext('2d');
if (window.myChart7KLHA_H != 0){
    window.myChart7KLHA_H.destroy();
}
window.myChart7KLHA_H = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

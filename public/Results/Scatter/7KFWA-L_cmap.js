...
var myChart7KFWA_L = 0;
var ctx = document.getElementById('7KFWA-L').getContext('2d');
if (window.myChart7KFWA_L != 0){
    window.myChart7KFWA_L.destroy();
}
window.myChart7KFWA_L = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

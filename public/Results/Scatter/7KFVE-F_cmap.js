...
var myChart7KFVE_F = 0;
var ctx = document.getElementById('7KFVE-F').getContext('2d');
if (window.myChart7KFVE_F != 0){
    window.myChart7KFVE_F.destroy();
}
window.myChart7KFVE_F = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

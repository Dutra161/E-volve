...
var myChart7K8UB_L = 0;
var ctx = document.getElementById('7K8UB-L').getContext('2d');
if (window.myChart7K8UB_L != 0){
    window.myChart7K8UB_L.destroy();
}
window.myChart7K8UB_L = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

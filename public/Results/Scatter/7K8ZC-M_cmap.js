...
var myChart7K8ZC_M = 0;
var ctx = document.getElementById('7K8ZC-M').getContext('2d');
if (window.myChart7K8ZC_M != 0){
    window.myChart7K8ZC_M.destroy();
}
window.myChart7K8ZC_M = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

...
var myChart7CWUB_G = 0;
var ctx = document.getElementById('7CWUB-G').getContext('2d');
if (window.myChart7CWUB_G != 0){
    window.myChart7CWUB_G.destroy();
}
window.myChart7CWUB_G = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

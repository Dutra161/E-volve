...
var myChart7K90A_N = 0;
var ctx = document.getElementById('7K90A-N').getContext('2d');
if (window.myChart7K90A_N != 0){
    window.myChart7K90A_N.destroy();
}
window.myChart7K90A_N = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

...
var myChart7K4NA_L = 0;
var ctx = document.getElementById('7K4NA-L').getContext('2d');
if (window.myChart7K4NA_L != 0){
    window.myChart7K4NA_L.destroy();
}
window.myChart7K4NA_L = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

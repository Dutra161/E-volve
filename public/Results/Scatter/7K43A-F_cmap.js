...
var myChart7K43A_F = 0;
var ctx = document.getElementById('7K43A-F').getContext('2d');
if (window.myChart7K43A_F != 0){
    window.myChart7K43A_F.destroy();
}
window.myChart7K43A_F = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

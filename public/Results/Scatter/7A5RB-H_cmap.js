...
var myChart7A5RB_H = 0;
var ctx = document.getElementById('7A5RB-H').getContext('2d');
if (window.myChart7A5RB_H != 0){
    window.myChart7A5RB_H.destroy();
}
window.myChart7A5RB_H = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

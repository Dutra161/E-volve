...
var myChart7CWUC_M = 0;
var ctx = document.getElementById('7CWUC-M').getContext('2d');
if (window.myChart7CWUC_M != 0){
    window.myChart7CWUC_M.destroy();
}
window.myChart7CWUC_M = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

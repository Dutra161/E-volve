...
var myChart7KLGA_H = 0;
var ctx = document.getElementById('7KLGA-H').getContext('2d');
if (window.myChart7KLGA_H != 0){
    window.myChart7KLGA_H.destroy();
}
window.myChart7KLGA_H = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

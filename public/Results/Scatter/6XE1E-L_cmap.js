...
var myChart6XE1E_L = 0;
var ctx = document.getElementById('6XE1E-L').getContext('2d');
if (window.myChart6XE1E_L != 0){
    window.myChart6XE1E_L.destroy();
}
window.myChart6XE1E_L = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

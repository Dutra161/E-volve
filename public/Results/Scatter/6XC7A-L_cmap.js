...
var myChart6XC7A_L = 0;
var ctx = document.getElementById('6XC7A-L').getContext('2d');
if (window.myChart6XC7A_L != 0){
    window.myChart6XC7A_L.destroy();
}
window.myChart6XC7A_L = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

...
var myChart7DPMI_H = 0;
var ctx = document.getElementById('7DPMI-H').getContext('2d');
if (window.myChart7DPMI_H != 0){
    window.myChart7DPMI_H.destroy();
}
window.myChart7DPMI_H = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

...
var myChart7L06B_G = 0;
var ctx = document.getElementById('7L06B-G').getContext('2d');
if (window.myChart7L06B_G != 0){
    window.myChart7L06B_G.destroy();
}
window.myChart7L06B_G = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

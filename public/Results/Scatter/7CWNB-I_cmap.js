...
var myChart7CWNB_I = 0;
var ctx = document.getElementById('7CWNB-I').getContext('2d');
if (window.myChart7CWNB_I != 0){
    window.myChart7CWNB_I.destroy();
}
window.myChart7CWNB_I = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

...
var myChart6XCMB_S = 0;
var ctx = document.getElementById('6XCMB-S').getContext('2d');
if (window.myChart6XCMB_S != 0){
    window.myChart6XCMB_S.destroy();
}
window.myChart6XCMB_S = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

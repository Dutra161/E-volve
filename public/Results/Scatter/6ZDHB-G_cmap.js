...
var myChart6ZDHB_G = 0;
var ctx = document.getElementById('6ZDHB-G').getContext('2d');
if (window.myChart6ZDHB_G != 0){
    window.myChart6ZDHB_G.destroy();
}
window.myChart6ZDHB_G = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

...
var myChart7K43A_G = 0;
var ctx = document.getElementById('7K43A-G').getContext('2d');
if (window.myChart7K43A_G != 0){
    window.myChart7K43A_G.destroy();
}
window.myChart7K43A_G = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

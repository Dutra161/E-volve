...
var myChart7KXKB_I = 0;
var ctx = document.getElementById('7KXKB-I').getContext('2d');
if (window.myChart7KXKB_I != 0){
    window.myChart7KXKB_I.destroy();
}
window.myChart7KXKB_I = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

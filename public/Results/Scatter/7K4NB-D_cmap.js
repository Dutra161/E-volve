...
var myChart7K4NB_D = 0;
var ctx = document.getElementById('7K4NB-D').getContext('2d');
if (window.myChart7K4NB_D != 0){
    window.myChart7K4NB_D.destroy();
}
window.myChart7K4NB_D = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

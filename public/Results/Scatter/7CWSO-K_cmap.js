...
var myChart7CWSO_K = 0;
var ctx = document.getElementById('7CWSO-K').getContext('2d');
if (window.myChart7CWSO_K != 0){
    window.myChart7CWSO_K.destroy();
}
window.myChart7CWSO_K = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

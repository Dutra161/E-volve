...
var myChart7KMLA_H = 0;
var ctx = document.getElementById('7KMLA-H').getContext('2d');
if (window.myChart7KMLA_H != 0){
    window.myChart7KMLA_H.destroy();
}
window.myChart7KMLA_H = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

...
var myChart7C8WB_A = 0;
var ctx = document.getElementById('7C8WB-A').getContext('2d');
if (window.myChart7C8WB_A != 0){
    window.myChart7C8WB_A.destroy();
}
window.myChart7C8WB_A = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

...
var myChart6ZDHB_D = 0;
var ctx = document.getElementById('6ZDHB-D').getContext('2d');
if (window.myChart6ZDHB_D != 0){
    window.myChart6ZDHB_D.destroy();
}
window.myChart6ZDHB_D = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

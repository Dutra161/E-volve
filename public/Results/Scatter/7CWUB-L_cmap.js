...
var myChart7CWUB_L = 0;
var ctx = document.getElementById('7CWUB-L').getContext('2d');
if (window.myChart7CWUB_L != 0){
    window.myChart7CWUB_L.destroy();
}
window.myChart7CWUB_L = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

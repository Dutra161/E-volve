...
var myChart7CWSQ_C = 0;
var ctx = document.getElementById('7CWSQ-C').getContext('2d');
if (window.myChart7CWSQ_C != 0){
    window.myChart7CWSQ_C.destroy();
}
window.myChart7CWSQ_C = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

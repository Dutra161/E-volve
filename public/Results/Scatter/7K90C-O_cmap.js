...
var myChart7K90C_O = 0;
var ctx = document.getElementById('7K90C-O').getContext('2d');
if (window.myChart7K90C_O != 0){
    window.myChart7K90C_O.destroy();
}
window.myChart7K90C_O = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

...
var myChart7K8SA_H = 0;
var ctx = document.getElementById('7K8SA-H').getContext('2d');
if (window.myChart7K8SA_H != 0){
    window.myChart7K8SA_H.destroy();
}
window.myChart7K8SA_H = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

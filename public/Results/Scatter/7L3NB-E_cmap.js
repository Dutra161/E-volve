...
var myChart7L3NB_E = 0;
var ctx = document.getElementById('7L3NB-E').getContext('2d');
if (window.myChart7L3NB_E != 0){
    window.myChart7L3NB_E.destroy();
}
window.myChart7L3NB_E = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

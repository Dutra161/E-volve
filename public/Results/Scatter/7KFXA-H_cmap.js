...
var myChart7KFXA_H = 0;
var ctx = document.getElementById('7KFXA-H').getContext('2d');
if (window.myChart7KFXA_H != 0){
    window.myChart7KFXA_H.destroy();
}
window.myChart7KFXA_H = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

...
var myChart7K45B_H = 0;
var ctx = document.getElementById('7K45B-H').getContext('2d');
if (window.myChart7K45B_H != 0){
    window.myChart7K45B_H.destroy();
}
window.myChart7K45B_H = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

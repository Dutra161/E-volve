...
var myChart7CAKB_F = 0;
var ctx = document.getElementById('7CAKB-F').getContext('2d');
if (window.myChart7CAKB_F != 0){
    window.myChart7CAKB_F.destroy();
}
window.myChart7CAKB_F = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

...
var myChart7K43A_H = 0;
var ctx = document.getElementById('7K43A-H').getContext('2d');
if (window.myChart7K43A_H != 0){
    window.myChart7K43A_H.destroy();
}
window.myChart7K43A_H = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

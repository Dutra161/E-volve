...
var myChart7CWUA_F = 0;
var ctx = document.getElementById('7CWUA-F').getContext('2d');
if (window.myChart7CWUA_F != 0){
    window.myChart7CWUA_F.destroy();
}
window.myChart7CWUA_F = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

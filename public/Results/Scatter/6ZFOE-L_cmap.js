...
var myChart6ZFOE_L = 0;
var ctx = document.getElementById('6ZFOE-L').getContext('2d');
if (window.myChart6ZFOE_L != 0){
    window.myChart6ZFOE_L.destroy();
}
window.myChart6ZFOE_L = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

...
var myChart7L2CB_D = 0;
var ctx = document.getElementById('7L2CB-D').getContext('2d');
if (window.myChart7L2CB_D != 0){
    window.myChart7L2CB_D.destroy();
}
window.myChart7L2CB_D = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

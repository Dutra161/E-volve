...
var myChart7KFYA_L = 0;
var ctx = document.getElementById('7KFYA-L').getContext('2d');
if (window.myChart7KFYA_L != 0){
    window.myChart7KFYA_L.destroy();
}
window.myChart7KFYA_L = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

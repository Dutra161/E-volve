...
var myChart7KXKC_N = 0;
var ctx = document.getElementById('7KXKC-N').getContext('2d');
if (window.myChart7KXKC_N != 0){
    window.myChart7KXKC_N.destroy();
}
window.myChart7KXKC_N = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

...
var myChart7CWNB_K = 0;
var ctx = document.getElementById('7CWNB-K').getContext('2d');
if (window.myChart7CWNB_K != 0){
    window.myChart7CWNB_K.destroy();
}
window.myChart7CWNB_K = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

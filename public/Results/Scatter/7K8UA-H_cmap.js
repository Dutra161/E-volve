...
var myChart7K8UA_H = 0;
var ctx = document.getElementById('7K8UA-H').getContext('2d');
if (window.myChart7K8UA_H != 0){
    window.myChart7K8UA_H.destroy();
}
window.myChart7K8UA_H = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

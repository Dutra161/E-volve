...
var myChart6ZDGD_B = 0;
var ctx = document.getElementById('6ZDGD-B').getContext('2d');
if (window.myChart6ZDGD_B != 0){
    window.myChart6ZDGD_B.destroy();
}
window.myChart6ZDGD_B = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

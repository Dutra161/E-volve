...
var myChart7JV4A_H = 0;
var ctx = document.getElementById('7JV4A-H').getContext('2d');
if (window.myChart7JV4A_H != 0){
    window.myChart7JV4A_H.destroy();
}
window.myChart7JV4A_H = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

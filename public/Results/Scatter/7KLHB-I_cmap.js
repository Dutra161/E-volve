...
var myChart7KLHB_I = 0;
var ctx = document.getElementById('7KLHB-I').getContext('2d');
if (window.myChart7KLHB_I != 0){
    window.myChart7KLHB_I.destroy();
}
window.myChart7KLHB_I = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

...
var myChart7K8SC_M = 0;
var ctx = document.getElementById('7K8SC-M').getContext('2d');
if (window.myChart7K8SC_M != 0){
    window.myChart7K8SC_M.destroy();
}
window.myChart7K8SC_M = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

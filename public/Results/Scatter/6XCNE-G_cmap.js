...
var myChart6XCNE_G = 0;
var ctx = document.getElementById('6XCNE-G').getContext('2d');
if (window.myChart6XCNE_G != 0){
    window.myChart6XCNE_G.destroy();
}
window.myChart6XCNE_G = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

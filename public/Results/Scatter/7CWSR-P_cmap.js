...
var myChart7CWSR_P = 0;
var ctx = document.getElementById('7CWSR-P').getContext('2d');
if (window.myChart7CWSR_P != 0){
    window.myChart7CWSR_P.destroy();
}
window.myChart7CWSR_P = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

...
var myChart7CWNA_M = 0;
var ctx = document.getElementById('7CWNA-M').getContext('2d');
if (window.myChart7CWNA_M != 0){
    window.myChart7CWNA_M.destroy();
}
window.myChart7CWNA_M = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

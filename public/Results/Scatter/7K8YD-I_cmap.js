...
var myChart7K8YD_I = 0;
var ctx = document.getElementById('7K8YD-I').getContext('2d');
if (window.myChart7K8YD_I != 0){
    window.myChart7K8YD_I.destroy();
}
window.myChart7K8YD_I = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

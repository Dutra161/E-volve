...
var myChart7CWNB_D = 0;
var ctx = document.getElementById('7CWNB-D').getContext('2d');
if (window.myChart7CWNB_D != 0){
    window.myChart7CWNB_D.destroy();
}
window.myChart7CWNB_D = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

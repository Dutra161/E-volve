...
var myChart7CWLC_I = 0;
var ctx = document.getElementById('7CWLC-I').getContext('2d');
if (window.myChart7CWLC_I != 0){
    window.myChart7CWLC_I.destroy();
}
window.myChart7CWLC_I = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

...
var myChart7L3NC_D = 0;
var ctx = document.getElementById('7L3NC-D').getContext('2d');
if (window.myChart7L3NC_D != 0){
    window.myChart7L3NC_D.destroy();
}
window.myChart7L3NC_D = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

...
var myChart7JVCB_D = 0;
var ctx = document.getElementById('7JVCB-D').getContext('2d');
if (window.myChart7JVCB_D != 0){
    window.myChart7JVCB_D.destroy();
}
window.myChart7JVCB_D = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

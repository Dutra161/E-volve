...
var myChart6ZDGE_L = 0;
var ctx = document.getElementById('6ZDGE-L').getContext('2d');
if (window.myChart6ZDGE_L != 0){
    window.myChart6ZDGE_L.destroy();
}
window.myChart6ZDGE_L = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

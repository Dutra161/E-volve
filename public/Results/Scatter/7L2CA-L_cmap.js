...
var myChart7L2CA_L = 0;
var ctx = document.getElementById('7L2CA-L').getContext('2d');
if (window.myChart7L2CA_L != 0){
    window.myChart7L2CA_L.destroy();
}
window.myChart7L2CA_L = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

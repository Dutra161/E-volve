...
var myChart7K8TB_N = 0;
var ctx = document.getElementById('7K8TB-N').getContext('2d');
if (window.myChart7K8TB_N != 0){
    window.myChart7K8TB_N.destroy();
}
window.myChart7K8TB_N = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

...
var myChart7DPMF_G = 0;
var ctx = document.getElementById('7DPMF-G').getContext('2d');
if (window.myChart7DPMF_G != 0){
    window.myChart7DPMF_G.destroy();
}
window.myChart7DPMF_G = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

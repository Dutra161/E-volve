...
var myChart7CWLB_G = 0;
var ctx = document.getElementById('7CWLB-G').getContext('2d');
if (window.myChart7CWLB_G != 0){
    window.myChart7CWLB_G.destroy();
}
window.myChart7CWLB_G = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

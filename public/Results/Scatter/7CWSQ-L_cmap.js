...
var myChart7CWSQ_L = 0;
var ctx = document.getElementById('7CWSQ-L').getContext('2d');
if (window.myChart7CWSQ_L != 0){
    window.myChart7CWSQ_L.destroy();
}
window.myChart7CWSQ_L = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

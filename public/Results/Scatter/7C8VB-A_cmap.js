...
var myChart7C8VB_A = 0;
var ctx = document.getElementById('7C8VB-A').getContext('2d');
if (window.myChart7C8VB_A != 0){
    window.myChart7C8VB_A.destroy();
}
window.myChart7C8VB_A = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

...
var myChart7LD1B_L = 0;
var ctx = document.getElementById('7LD1B-L').getContext('2d');
if (window.myChart7LD1B_L != 0){
    window.myChart7LD1B_L.destroy();
}
window.myChart7LD1B_L = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

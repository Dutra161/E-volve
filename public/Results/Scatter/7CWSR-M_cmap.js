...
var myChart7CWSR_M = 0;
var ctx = document.getElementById('7CWSR-M').getContext('2d');
if (window.myChart7CWSR_M != 0){
    window.myChart7CWSR_M.destroy();
}
window.myChart7CWSR_M = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

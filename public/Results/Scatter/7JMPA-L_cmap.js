...
var myChart7JMPA_L = 0;
var ctx = document.getElementById('7JMPA-L').getContext('2d');
if (window.myChart7JMPA_L != 0){
    window.myChart7JMPA_L.destroy();
}
window.myChart7JMPA_L = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

...
var myChart7A5RA_I = 0;
var ctx = document.getElementById('7A5RA-I').getContext('2d');
if (window.myChart7A5RA_I != 0){
    window.myChart7A5RA_I.destroy();
}
window.myChart7A5RA_I = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

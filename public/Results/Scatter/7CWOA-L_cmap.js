...
var myChart7CWOA_L = 0;
var ctx = document.getElementById('7CWOA-L').getContext('2d');
if (window.myChart7CWOA_L != 0){
    window.myChart7CWOA_L.destroy();
}
window.myChart7CWOA_L = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

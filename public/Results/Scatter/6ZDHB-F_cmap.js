...
var myChart6ZDHB_F = 0;
var ctx = document.getElementById('6ZDHB-F').getContext('2d');
if (window.myChart6ZDHB_F != 0){
    window.myChart6ZDHB_F.destroy();
}
window.myChart6ZDHB_F = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

...
var myChart7CWUC_R = 0;
var ctx = document.getElementById('7CWUC-R').getContext('2d');
if (window.myChart7CWUC_R != 0){
    window.myChart7CWUC_R.destroy();
}
window.myChart7CWUC_R = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

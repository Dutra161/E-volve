...
var myChart7C01B_D = 0;
var ctx = document.getElementById('7C01B-D').getContext('2d');
if (window.myChart7C01B_D != 0){
    window.myChart7C01B_D.destroy();
}
window.myChart7C01B_D = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

...
var myChart7JVCA_L = 0;
var ctx = document.getElementById('7JVCA-L').getContext('2d');
if (window.myChart7JVCA_L != 0){
    window.myChart7JVCA_L.destroy();
}
window.myChart7JVCA_L = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

...
var myChart6XC7A_D = 0;
var ctx = document.getElementById('6XC7A-D').getContext('2d');
if (window.myChart6XC7A_D != 0){
    window.myChart6XC7A_D.destroy();
}
window.myChart6XC7A_D = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

...
var myChart7CDIE_L = 0;
var ctx = document.getElementById('7CDIE-L').getContext('2d');
if (window.myChart7CDIE_L != 0){
    window.myChart7CDIE_L.destroy();
}
window.myChart7CDIE_L = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

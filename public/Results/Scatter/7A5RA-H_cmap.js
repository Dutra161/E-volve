...
var myChart7A5RA_H = 0;
var ctx = document.getElementById('7A5RA-H').getContext('2d');
if (window.myChart7A5RA_H != 0){
    window.myChart7A5RA_H.destroy();
}
window.myChart7A5RA_H = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

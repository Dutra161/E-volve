...
var myChart7JV4B_E = 0;
var ctx = document.getElementById('7JV4B-E').getContext('2d');
if (window.myChart7JV4B_E != 0){
    window.myChart7JV4B_E.destroy();
}
window.myChart7JV4B_E = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

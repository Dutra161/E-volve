...
var myChart7JV6B_D = 0;
var ctx = document.getElementById('7JV6B-D').getContext('2d');
if (window.myChart7JV6B_D != 0){
    window.myChart7JV6B_D.destroy();
}
window.myChart7JV6B_D = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

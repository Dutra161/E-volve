...
var myChart7L3NB_D = 0;
var ctx = document.getElementById('7L3NB-D').getContext('2d');
if (window.myChart7L3NB_D != 0){
    window.myChart7L3NB_D.destroy();
}
window.myChart7L3NB_D = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

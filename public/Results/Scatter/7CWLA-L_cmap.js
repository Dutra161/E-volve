...
var myChart7CWLA_L = 0;
var ctx = document.getElementById('7CWLA-L').getContext('2d');
if (window.myChart7CWLA_L != 0){
    window.myChart7CWLA_L.destroy();
}
window.myChart7CWLA_L = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

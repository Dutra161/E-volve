...
var myChart6XCMC_L = 0;
var ctx = document.getElementById('6XCMC-L').getContext('2d');
if (window.myChart6XCMC_L != 0){
    window.myChart6XCMC_L.destroy();
}
window.myChart6XCMC_L = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

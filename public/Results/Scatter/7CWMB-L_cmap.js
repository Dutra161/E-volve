...
var myChart7CWMB_L = 0;
var ctx = document.getElementById('7CWMB-L').getContext('2d');
if (window.myChart7CWMB_L != 0){
    window.myChart7CWMB_L.destroy();
}
window.myChart7CWMB_L = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

...
var myChart6XDGE_D = 0;
var ctx = document.getElementById('6XDGE-D').getContext('2d');
if (window.myChart6XDGE_D != 0){
    window.myChart6XDGE_D.destroy();
}
window.myChart6XDGE_D = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

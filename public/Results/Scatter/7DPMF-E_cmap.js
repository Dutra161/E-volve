...
var myChart7DPMF_E = 0;
var ctx = document.getElementById('7DPMF-E').getContext('2d');
if (window.myChart7DPMF_E != 0){
    window.myChart7DPMF_E.destroy();
}
window.myChart7DPMF_E = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

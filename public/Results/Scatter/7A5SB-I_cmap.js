...
var myChart7A5SB_I = 0;
var ctx = document.getElementById('7A5SB-I').getContext('2d');
if (window.myChart7A5SB_I != 0){
    window.myChart7A5SB_I.destroy();
}
window.myChart7A5SB_I = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

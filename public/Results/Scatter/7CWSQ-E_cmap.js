...
var myChart7CWSQ_E = 0;
var ctx = document.getElementById('7CWSQ-E').getContext('2d');
if (window.myChart7CWSQ_E != 0){
    window.myChart7CWSQ_E.destroy();
}
window.myChart7CWSQ_E = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

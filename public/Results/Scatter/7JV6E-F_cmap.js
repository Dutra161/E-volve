...
var myChart7JV6E_F = 0;
var ctx = document.getElementById('7JV6E-F').getContext('2d');
if (window.myChart7JV6E_F != 0){
    window.myChart7JV6E_F.destroy();
}
window.myChart7JV6E_F = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

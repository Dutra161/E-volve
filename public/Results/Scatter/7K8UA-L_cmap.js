...
var myChart7K8UA_L = 0;
var ctx = document.getElementById('7K8UA-L').getContext('2d');
if (window.myChart7K8UA_L != 0){
    window.myChart7K8UA_L.destroy();
}
window.myChart7K8UA_L = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

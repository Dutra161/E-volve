...
var myChart7LD1B_N = 0;
var ctx = document.getElementById('7LD1B-N').getContext('2d');
if (window.myChart7LD1B_N != 0){
    window.myChart7LD1B_N.destroy();
}
window.myChart7LD1B_N = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

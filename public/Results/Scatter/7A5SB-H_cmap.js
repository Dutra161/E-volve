...
var myChart7A5SB_H = 0;
var ctx = document.getElementById('7A5SB-H').getContext('2d');
if (window.myChart7A5SB_H != 0){
    window.myChart7A5SB_H.destroy();
}
window.myChart7A5SB_H = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

...
var myChart7JV4C_F = 0;
var ctx = document.getElementById('7JV4C-F').getContext('2d');
if (window.myChart7JV4C_F != 0){
    window.myChart7JV4C_F.destroy();
}
window.myChart7JV4C_F = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

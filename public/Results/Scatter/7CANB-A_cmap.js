...
var myChart7CANB_A = 0;
var ctx = document.getElementById('7CANB-A').getContext('2d');
if (window.myChart7CANB_A != 0){
    window.myChart7CANB_A.destroy();
}
window.myChart7CANB_A = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

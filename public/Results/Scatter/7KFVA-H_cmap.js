...
var myChart7KFVA_H = 0;
var ctx = document.getElementById('7KFVA-H').getContext('2d');
if (window.myChart7KFVA_H != 0){
    window.myChart7KFVA_H.destroy();
}
window.myChart7KFVA_H = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

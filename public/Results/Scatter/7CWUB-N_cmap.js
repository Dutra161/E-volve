...
var myChart7CWUB_N = 0;
var ctx = document.getElementById('7CWUB-N').getContext('2d');
if (window.myChart7CWUB_N != 0){
    window.myChart7CWUB_N.destroy();
}
window.myChart7CWUB_N = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

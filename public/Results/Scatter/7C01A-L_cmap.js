...
var myChart7C01A_L = 0;
var ctx = document.getElementById('7C01A-L').getContext('2d');
if (window.myChart7C01A_L != 0){
    window.myChart7C01A_L.destroy();
}
window.myChart7C01A_L = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

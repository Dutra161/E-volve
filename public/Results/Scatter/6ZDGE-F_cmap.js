...
var myChart6ZDGE_F = 0;
var ctx = document.getElementById('6ZDGE-F').getContext('2d');
if (window.myChart6ZDGE_F != 0){
    window.myChart6ZDGE_F.destroy();
}
window.myChart6ZDGE_F = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

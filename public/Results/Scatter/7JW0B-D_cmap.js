...
var myChart7JW0B_D = 0;
var ctx = document.getElementById('7JW0B-D').getContext('2d');
if (window.myChart7JW0B_D != 0){
    window.myChart7JW0B_D.destroy();
}
window.myChart7JW0B_D = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

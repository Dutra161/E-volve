...
var myChart7K4NA_H = 0;
var ctx = document.getElementById('7K4NA-H').getContext('2d');
if (window.myChart7K4NA_H != 0){
    window.myChart7K4NA_H.destroy();
}
window.myChart7K4NA_H = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

...
var myChart7KMLC_N = 0;
var ctx = document.getElementById('7KMLC-N').getContext('2d');
if (window.myChart7KMLC_N != 0){
    window.myChart7KMLC_N.destroy();
}
window.myChart7KMLC_N = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

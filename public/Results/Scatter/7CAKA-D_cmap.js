...
var myChart7CAKA_D = 0;
var ctx = document.getElementById('7CAKA-D').getContext('2d');
if (window.myChart7CAKA_D != 0){
    window.myChart7CAKA_D.destroy();
}
window.myChart7CAKA_D = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

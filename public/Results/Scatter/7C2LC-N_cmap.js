...
var myChart7C2LC_N = 0;
var ctx = document.getElementById('7C2LC-N').getContext('2d');
if (window.myChart7C2LC_N != 0){
    window.myChart7C2LC_N.destroy();
}
window.myChart7C2LC_N = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

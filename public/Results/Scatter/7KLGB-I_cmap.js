...
var myChart7KLGB_I = 0;
var ctx = document.getElementById('7KLGB-I').getContext('2d');
if (window.myChart7KLGB_I != 0){
    window.myChart7KLGB_I.destroy();
}
window.myChart7KLGB_I = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

...
var myChart7K8XA_G = 0;
var ctx = document.getElementById('7K8XA-G').getContext('2d');
if (window.myChart7K8XA_G != 0){
    window.myChart7K8XA_G.destroy();
}
window.myChart7K8XA_G = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

...
var myChart6ZDHC_I = 0;
var ctx = document.getElementById('6ZDHC-I').getContext('2d');
if (window.myChart6ZDHC_I != 0){
    window.myChart6ZDHC_I.destroy();
}
window.myChart6ZDHC_I = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

...
var myChart6XC3C_L = 0;
var ctx = document.getElementById('6XC3C-L').getContext('2d');
if (window.myChart6XC3C_L != 0){
    window.myChart6XC3C_L.destroy();
}
window.myChart6XC3C_L = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

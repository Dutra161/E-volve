...
var myChart6ZDHA_D = 0;
var ctx = document.getElementById('6ZDHA-D').getContext('2d');
if (window.myChart6ZDHA_D != 0){
    window.myChart6ZDHA_D.destroy();
}
window.myChart6ZDHA_D = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

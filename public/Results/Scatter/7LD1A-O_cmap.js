...
var myChart7LD1A_O = 0;
var ctx = document.getElementById('7LD1A-O').getContext('2d');
if (window.myChart7LD1A_O != 0){
    window.myChart7LD1A_O.destroy();
}
window.myChart7LD1A_O = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

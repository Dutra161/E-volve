...
var myChart7KLGB_M = 0;
var ctx = document.getElementById('7KLGB-M').getContext('2d');
if (window.myChart7KLGB_M != 0){
    window.myChart7KLGB_M.destroy();
}
window.myChart7KLGB_M = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

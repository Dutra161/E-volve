...
var myChart6XKPA_H = 0;
var ctx = document.getElementById('6XKPA-H').getContext('2d');
if (window.myChart6XKPA_H != 0){
    window.myChart6XKPA_H.destroy();
}
window.myChart6XKPA_H = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

...
var myChart7K4NB_C = 0;
var ctx = document.getElementById('7K4NB-C').getContext('2d');
if (window.myChart7K4NB_C != 0){
    window.myChart7K4NB_C.destroy();
}
window.myChart7K4NB_C = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

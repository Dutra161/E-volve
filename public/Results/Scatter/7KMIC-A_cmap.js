...
var myChart7KMIC_A = 0;
var ctx = document.getElementById('7KMIC-A').getContext('2d');
if (window.myChart7KMIC_A != 0){
    window.myChart7KMIC_A.destroy();
}
window.myChart7KMIC_A = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

...
var myChart7C2LB_M = 0;
var ctx = document.getElementById('7C2LB-M').getContext('2d');
if (window.myChart7C2LB_M != 0){
    window.myChart7C2LB_M.destroy();
}
window.myChart7C2LB_M = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

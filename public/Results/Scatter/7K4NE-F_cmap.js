...
var myChart7K4NE_F = 0;
var ctx = document.getElementById('7K4NE-F').getContext('2d');
if (window.myChart7K4NE_F != 0){
    window.myChart7K4NE_F.destroy();
}
window.myChart7K4NE_F = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

...
var myChart7CAKC_H = 0;
var ctx = document.getElementById('7CAKC-H').getContext('2d');
if (window.myChart7CAKC_H != 0){
    window.myChart7CAKC_H.destroy();
}
window.myChart7CAKC_H = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

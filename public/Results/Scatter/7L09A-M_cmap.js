...
var myChart7L09A_M = 0;
var ctx = document.getElementById('7L09A-M').getContext('2d');
if (window.myChart7L09A_M != 0){
    window.myChart7L09A_M.destroy();
}
window.myChart7L09A_M = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

...
var myChart7JW0B_C = 0;
var ctx = document.getElementById('7JW0B-C').getContext('2d');
if (window.myChart7JW0B_C != 0){
    window.myChart7JW0B_C.destroy();
}
window.myChart7JW0B_C = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

...
var myChart7KXJA_L = 0;
var ctx = document.getElementById('7KXJA-L').getContext('2d');
if (window.myChart7KXJA_L != 0){
    window.myChart7KXJA_L.destroy();
}
window.myChart7KXJA_L = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

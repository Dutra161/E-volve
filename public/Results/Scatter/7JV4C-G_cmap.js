...
var myChart7JV4C_G = 0;
var ctx = document.getElementById('7JV4C-G').getContext('2d');
if (window.myChart7JV4C_G != 0){
    window.myChart7JV4C_G.destroy();
}
window.myChart7JV4C_G = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

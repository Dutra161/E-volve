...
var myChart7CWLA_H = 0;
var ctx = document.getElementById('7CWLA-H').getContext('2d');
if (window.myChart7CWLA_H != 0){
    window.myChart7CWLA_H.destroy();
}
window.myChart7CWLA_H = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

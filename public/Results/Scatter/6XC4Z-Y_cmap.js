...
var myChart6XC4Z_Y = 0;
var ctx = document.getElementById('6XC4Z-Y').getContext('2d');
if (window.myChart6XC4Z_Y != 0){
    window.myChart6XC4Z_Y.destroy();
}
window.myChart6XC4Z_Y = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

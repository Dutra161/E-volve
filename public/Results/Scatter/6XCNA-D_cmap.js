...
var myChart6XCNA_D = 0;
var ctx = document.getElementById('6XCNA-D').getContext('2d');
if (window.myChart6XCNA_D != 0){
    window.myChart6XCNA_D.destroy();
}
window.myChart6XCNA_D = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

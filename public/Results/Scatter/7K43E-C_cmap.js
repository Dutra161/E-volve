...
var myChart7K43E_C = 0;
var ctx = document.getElementById('7K43E-C').getContext('2d');
if (window.myChart7K43E_C != 0){
    window.myChart7K43E_C.destroy();
}
window.myChart7K43E_C = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

...
var myChart7JVCB_C = 0;
var ctx = document.getElementById('7JVCB-C').getContext('2d');
if (window.myChart7JVCB_C != 0){
    window.myChart7JVCB_C.destroy();
}
window.myChart7JVCB_C = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

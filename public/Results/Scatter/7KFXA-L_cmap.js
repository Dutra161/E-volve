...
var myChart7KFXA_L = 0;
var ctx = document.getElementById('7KFXA-L').getContext('2d');
if (window.myChart7KFXA_L != 0){
    window.myChart7KFXA_L.destroy();
}
window.myChart7KFXA_L = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

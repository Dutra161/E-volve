...
var myChart7CWMC_K = 0;
var ctx = document.getElementById('7CWMC-K').getContext('2d');
if (window.myChart7CWMC_K != 0){
    window.myChart7CWMC_K.destroy();
}
window.myChart7CWMC_K = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

...
var myChart7KMHC_A = 0;
var ctx = document.getElementById('7KMHC-A').getContext('2d');
if (window.myChart7KMHC_A != 0){
    window.myChart7KMHC_A.destroy();
}
window.myChart7KMHC_A = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

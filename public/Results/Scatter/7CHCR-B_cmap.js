...
var myChart7CHCR_B = 0;
var ctx = document.getElementById('7CHCR-B').getContext('2d');
if (window.myChart7CHCR_B != 0){
    window.myChart7CHCR_B.destroy();
}
window.myChart7CHCR_B = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

...
var myChart7CWMC_I = 0;
var ctx = document.getElementById('7CWMC-I').getContext('2d');
if (window.myChart7CWMC_I != 0){
    window.myChart7CWMC_I.destroy();
}
window.myChart7CWMC_I = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

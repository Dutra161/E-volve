...
var myChart7CWNA_F = 0;
var ctx = document.getElementById('7CWNA-F').getContext('2d');
if (window.myChart7CWNA_F != 0){
    window.myChart7CWNA_F.destroy();
}
window.myChart7CWNA_F = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

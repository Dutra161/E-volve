...
var myChart7C2LA_L = 0;
var ctx = document.getElementById('7C2LA-L').getContext('2d');
if (window.myChart7C2LA_L != 0){
    window.myChart7C2LA_L.destroy();
}
window.myChart7C2LA_L = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

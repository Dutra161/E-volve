...
var myChart6ZDHA_L = 0;
var ctx = document.getElementById('6ZDHA-L').getContext('2d');
if (window.myChart6ZDHA_L != 0){
    window.myChart6ZDHA_L.destroy();
}
window.myChart6ZDHA_L = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

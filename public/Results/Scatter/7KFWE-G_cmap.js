...
var myChart7KFWE_G = 0;
var ctx = document.getElementById('7KFWE-G').getContext('2d');
if (window.myChart7KFWE_G != 0){
    window.myChart7KFWE_G.destroy();
}
window.myChart7KFWE_G = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

...
var myChart7CWNC_L = 0;
var ctx = document.getElementById('7CWNC-L').getContext('2d');
if (window.myChart7CWNC_L != 0){
    window.myChart7CWNC_L.destroy();
}
window.myChart7CWNC_L = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

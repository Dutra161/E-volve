...
var myChart7JV6A_H = 0;
var ctx = document.getElementById('7JV6A-H').getContext('2d');
if (window.myChart7JV6A_H != 0){
    window.myChart7JV6A_H.destroy();
}
window.myChart7JV6A_H = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

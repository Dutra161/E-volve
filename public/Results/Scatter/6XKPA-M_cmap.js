...
var myChart6XKPA_M = 0;
var ctx = document.getElementById('6XKPA-M').getContext('2d');
if (window.myChart6XKPA_M != 0){
    window.myChart6XKPA_M.destroy();
}
window.myChart6XKPA_M = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',

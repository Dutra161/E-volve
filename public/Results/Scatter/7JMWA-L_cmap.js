...
var myChart7JMWA_L = 0;
var ctx = document.getElementById('7JMWA-L').getContext('2d');
if (window.myChart7JMWA_L != 0){
    window.myChart7JMWA_L.destroy();
}
window.myChart7JMWA_L = new Chart(ctx, {
    type: 'scatter',
    data: {
        datasets: [{
            pointStyle:'star',
